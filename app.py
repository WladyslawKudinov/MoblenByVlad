...
def next_stage():
    ...
    if stage == 0:  # Стадия 0: Ввод имени
        ...
        response = f"Рада знакомству давай начнем! Расскажи мне побольше о своем проекте: как он называется, как ты видишь его применение, кто твоя целевая аудитория и какие задачи он решает? "
